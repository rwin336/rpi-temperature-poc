...
def read_temp(temp_file):
  ...
  return time_c,temp_c


def mon_temp_v1(temp_file, device_type, device_id, scrape_rate, duration_secs):
  ...
  while time.time() - start_time < duration_secs:
    time_c,temp_c = read_temp(temp_file) 
    temp_f = (temp_c * 1.8) + 32 

    print(f"{time_c},{device_type},{device_id},{temp_c:.2f},{temp_f:.2f}") 
...
mon_temp_v1(w1_device_temperature_file, "w1", w1_device_id, scrape_rate_secs, duration_secs)
